                        ...
                        reject(
                            new Error(
                                `Не удалось связаться с НСПД (${errors.join("; ")}). ` +
                                    (viaProxy
                                        ? "Проверьте NSPD_BASES и что edge-прокси в РФ запущен."
                                        : "С зарубежных серверов (Render и т.п.) реестр часто недоступен — задайте NSPD_BASES на прокси в РФ (scripts/nspd-edge-proxy.mjs) или хостинг в РФ.")
                            )
                        );
                    }
                }
