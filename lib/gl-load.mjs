...
export const MIN_VOLOCHKOVA = 210; // Волочкова — любая заявка
...
export function minutesForApp(filename, fio, ahValue) {
    if (isVolochkova(fio)) return MIN_VOLOCHKOVA;
