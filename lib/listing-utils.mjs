...
export function relevanceScore(listing, context) {
    ...
    } else if (listing.matchedBy === "street") {
        score += 55;
        reasons.push("город и улица в БазаЦООП");
    } else if (listing.matchedBy === "address") {
        score += 45;
        reasons.push("тот же город в БазаЦООП");
...
export function buildSearchLinks(cadastralNumber, address) {
    ...
    return {
        ...
        bazacoopList: `https://bazacoop.ru/re/zemelnye-uchastki?${params}`,
