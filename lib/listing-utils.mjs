...
export function buildSearchLinks(cadastralNumber, address) {
    const q = encodeURIComponent(cadastralNumber);
    const addrQ = encodeURIComponent(address || cadastralNumber);
    return {
        avito: `https://www.avito.ru/rossiya/nedvizhimost?q=${addrQ}`,
        cian: `https://www.cian.ru/cat.php?deal_type=sale&cadastral_number=${encodeURIComponent(cadastralNumber)}`,
        domclick: `https://domclick.ru/search?text=${addrQ}`,
        kadbase: `https://kadbase.ru/search/`
    };
}
